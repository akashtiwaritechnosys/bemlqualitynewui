...
abstract class Vtiger_Connector {
	...
	abstract public function fetchRecords($module, $label, $q, $filter, $pageNo, $pageLimit, $orderBy, $order,$statusFilterName);
	...
	abstract public function forgotPassword($email, $username);
	...
	abstract public function fetchReferenceRecords($module, $query, $fetchReferenceRecords);
