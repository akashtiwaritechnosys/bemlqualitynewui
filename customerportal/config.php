...
class Portal_Config_Data {
	...
	protected static $data = array(
		...
		'crm.url' => 'http://10.80.2.84/bemlqualitynew',

		//Portal URL without trialing/
		//Example: http://yourdomain.com/portal
		'portal.url' => 'https://crm.bemlindia.in/bemlqualitynew/customerportal',
	...
	protected static function getData() {
		...
		if($_SERVER['HTTP_HOST'] == 'crm.bemlindia.in') {
			self::$data['portal.url'] = 'https://'. $_SERVER['HTTP_HOST'] .'/bemlqualitynew/customerportal';
		} else {
			self::$data['portal.url'] = 'http://'. $_SERVER['HTTP_HOST'] .'/bemlqualitynew/customerportal';
		}
