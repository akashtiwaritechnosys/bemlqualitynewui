...
class MTBF extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_mtbf';
	var $table_index= 'mtbfid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_mtbfcf', 'mtbfid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_mtbf', 'vtiger_mtbfcf');
	...
	function MTBF() {
		$this->log =LoggerManager::getLogger('MTBF');
		$this->db = PearDatabase::getInstance();
		$this->column_fields = getColumnFields('MTBF');
	}
