...
class CustomerPortal_Utils {
	...
	static function resolveRecordValues(&$record, $user = null, $ignoreUnsetFields = false) {
		$userTypeFields = array('assigned_user_id', 'creator', 'userid', 
		'created_user_id', 'modifiedby', 'folderid');
		...
		foreach ($imageDetails as $imageDetail) {
			...
			$attachment['attach_name'] = $imageDetail['name'];
			array_push($attachments, $attachment);
		}
		$record['imagename'] = $attachments;
		return $record;
	}
