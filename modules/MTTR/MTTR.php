...
class MTTR extends Vtiger_CRMEntity {
	var $table_name = 'vtiger_mttr';
	var $table_index= 'mttrid';

	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_mttrcf', 'mttrid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_mttr', 'vtiger_mttrcf');
	...
	function MTTR() {
		$this->log =LoggerManager::getLogger('MTTR');
		$this->db = PearDatabase::getInstance();
		$this->column_fields = getColumnFields('MTTR');
	}
