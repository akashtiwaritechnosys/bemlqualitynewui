...
class Vtiger_Field_Model extends Vtiger_Field {
	...
	public function getFieldDataType() {
		if(!$this->fieldDataType) {
			...
			if($uiType == '69') {
				...
				$fieldDataType = 'MultiSelectCheckBox';
	...
	public function getPicklistValues() {
        ...
        if($fieldDataType == 'picklist' || $fieldDataType == 'multipicklist' || $fieldDataType == 'metricpicklist' || $fieldDataType == 'timestring' ||  $fieldDataType == 'radio' || $fieldDataType == 'MultiSelectCheckBox') {
	...
	public function getEditablePicklistValues() {
        ...
        if($fieldDataType == 'picklist' || $fieldDataType == 'multipicklist' || $fieldDataType == 'radio' || $fieldDataType == 'MultiSelectCheckBox') {
            $fieldPickListValues = array();
            if($this->isRoleBased()) {
	...
	public function getFieldInfo() {
		...
		if($fieldDataType == 'picklist' || $fieldDataType == 'multipicklist' || $fieldDataType == 'multiowner' || $fieldDataType == 'radio' || $fieldDataType == 'MultiSelectCheckBox') {
