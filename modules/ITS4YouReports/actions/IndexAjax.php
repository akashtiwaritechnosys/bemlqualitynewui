...
//ITS4YouReports::sshow($record);
    ...
    function getFilterColHtml(Vtiger_Request $request) {
        ...
        $last_key = (ITS4YouReports_Functions_Helper::count($currField_arr) - 1);
...
//echo "<pre>";print_r($return_array);echo "</pre>";
        ...
        if (!empty($picklistValues)) {
            foreach ($picklistValues as $order => $pickListValue) {
                if (is_array($pickListValue)
                    || in_array($pickListValue, $valesCheck)) {
                    continue;
                }
        ...
        if (!empty($sel_fields)) {
            ...
            $count_sel_fields = ITS4YouReports_Functions_Helper::count($sel_fields);
            ...
            $n_i = $n_ci = 0;
            $count_n = ITS4YouReports_Functions_Helper::count($sel_fields);
    ...
    function getFilterDateHtml(Vtiger_Request $request) {
        ...
        if ($columnIndex != "") {
            ...
            if ($r_sel_fields != "") {
                ...
                } elseif (!in_array($fop_type, ['custom', 'a', 'b'])) {
                ...
                } elseif (in_array($fop_type, ['a', 'b', "todaymore", "older1days", "older7days", "older15days", "older30days", "older60days", "older90days", "older120days",])) {
            ...
            if (!in_array($fop_type, ['custom', 'a', 'b'])) {
                $readonly = "true";
            } else {
                $readonly = "false";
            }
...
//                }
    ...
    function getKeyMetricReportColumns(Vtiger_Request $request) {
        ...
        if ($record != "") {
            ...
            if (ITS4YouReports_Functions_Helper::count($type_checkout) > 1) {
