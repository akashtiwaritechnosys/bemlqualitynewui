...
class ITS4YouReports_Bing_Map {
    ...
    public static function getUserApiKeyType() {
        ITS4YouReports_UserMapsKeySettings_View::checkTable();
        $currentUser = Users_Record_Model::getCurrentUserModel();
    ...
    public static function resultsToTitle(array $reportData) {
        if (!empty($reportData)) {
            $found = (int) ITS4YouReports_Functions_Helper::count($reportData['found']);
            $notFound = (int) ITS4YouReports_Functions_Helper::count($reportData['not_found']);
