...
class UITypes {
	...
	public static function getClearName($name) {
        ...
        $clear_fld_calculation_type = strtoupper($nameArr[(ITS4YouReports_Functions_Helper::count($nameArr) - 1)]);
        unset($nameArr[(ITS4YouReports_Functions_Helper::count($nameArr) - 1)]);

        $lk = (ITS4YouReports_Functions_Helper::count($nameArr) - 1);
