...
class Leads_StatusUnderWarrantyEquipmentDetailed_View extends Vtiger_Index_View {
	...
	function showModuleDetailView(Vtiger_Request $request) {
		...
		$viewer->assign('REPORT_LABEL', 'DETAILS OF OFF ROAD UNDER WARRANTY EQUIPMENTS');
		global $adb;
		$headers = [
		...
		$sql = "SELECT vtiger_equipment.equipment_sl_no,dte_of_commissing,date_of_failure,vtiger_servicereports.hmr,no_of_days,
			...
			where  vtiger_servicereports.sr_war_status = 'Under Warranty' 
			and vtiger_servicereports.is_recommisionreport = 0
			and vtiger_servicereportscf.fd_ag_war_avl != 'YES'";
		...
		$viewer->assign('AgResultArray', $records);
		...
		return $viewer->view('StatusUnderWarrantyEquipmentDetailed.tpl', $moduleName, true);
	}
