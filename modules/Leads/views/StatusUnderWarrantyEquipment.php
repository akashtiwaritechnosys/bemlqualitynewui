...
class Leads_StatusUnderWarrantyEquipment_View extends Vtiger_Index_View {
	...
	function showModuleDetailView(Vtiger_Request $request) {
		...
		$viewer->assign('REPORT_LABEL', 'STATUS OF UNDER WARRANTY EQUIPMENT');
		global $adb;
		$sql = "SELECT equip_model,org_code,count(equip_model) as 'eq_run_war_st_count'
				...
				where eq_run_war_st = 'Under Warranty' and equip_category= 'S' group by equip_model,org_code";
		...
		return $viewer->view('StatusUnderWarrantyEquipment.tpl', $moduleName, true);
	}
	...
	function getTotalOffroadEquipments($model, $orgCode) {
		...
		$sqlResult = $adb->pquery($sql, array($model, $orgCode, 'Under Warranty'));
