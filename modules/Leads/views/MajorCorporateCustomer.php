...
class Leads_MajorCorporateCustomer_View extends Vtiger_Index_View {
	...
	function showModuleDetailView(Vtiger_Request $request) {
		...
		$viewer->assign('REPORT_LABEL', 'Major Corporate Customer');
		global $adb;

		$nonCoalCustomers = array("NLC", 'SCCL', 'NMDC', 'SAIL', 'NTPC', 'DGBR', 'E-IN-C', 'NALCO', 'MOIL');
		...
		return $viewer->view('MajorCorporateCustomer.tpl', $moduleName, true);
	}
