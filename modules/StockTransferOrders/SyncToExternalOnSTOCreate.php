...
function getProductsOfSTO($recordId, $recplantcode) {
    ...
    for ($i = 0; $i < $num_rows; $i++) {
        ...
        $product['LGORT'] = IGgetStoreLocationCodeOFValue('lid_store_locations', $adb->query_result($result, $i, 'lid_store_locations'));
...
function IGgetStoreLocationCodeOFValue($keyTable, $value) {
