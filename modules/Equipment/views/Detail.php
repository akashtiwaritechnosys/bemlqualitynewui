...
class Equipment_Detail_View extends Vtiger_Detail_View {
    ...
    public function showModuleDetailView(Vtiger_Request $request) {
		...
		$equipmentSerialNum = $recordModel->get('equipment_sl_no');
		$dataArr = [];
		foreach ($aggregates as $aggregate => $label) {
			$obj = [];
			$obj['aggregate'] = $aggregate;
			$obj['aggregateLabel'] = $label;
			$obj['aggregateInfo'] = IGgetAggregateDetailsImproved($aggregate, $equipmentSerialNum, $recordId);
        ...
        $viewer->assign('AllAggregatesInfo', $dataArr);
        $viewer->assign('EquipmentCategory', $recordModel->get('equip_category'));
