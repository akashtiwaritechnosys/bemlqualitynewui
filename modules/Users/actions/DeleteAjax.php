...
class Users_DeleteAjax_Action extends Vtiger_Delete_Action {
    ...
    public function process(Vtiger_Request $request) {
        ...
        if ($mode == 'permanent') {
            ...
            $this->getUserIdDetailsBasedOnEmployeeModuleG($ownerId);
            ...
            if ($request->get('permanent') == '1' || 1 == 1) {
                Users_Record_Model::deleteUserPermanently($ownerId, $newOwnerId);
            }
        }
    ...
    public function getUserIdDetailsBasedOnEmployeeModuleG($userId) {
        ...
        $sql = 'select serviceengineerid from vtiger_serviceengineer '
            ...
            . ' where vtiger_serviceengineer.badge_no = ? and vtiger_serviceengineer.approval_status = "Accepted" and vtiger_crmentity.deleted = 0 limit 1';
        ...
        if ($num_rows > 0) {
            ...
            $recordId = $userData['serviceengineerid'];
