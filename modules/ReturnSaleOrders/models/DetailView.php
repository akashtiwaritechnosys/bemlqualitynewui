...
class ReturnSaleOrders_DetailView_Model extends Inventory_DetailView_Model {
    ...
    public function getDetailViewLinks($linkParams) {
        ...
        $linkModelList = array();
        $isEditableAsPerFlow = $this->IGisEditable($recordId);
        if (Users_Privileges_Model::isPermitted($moduleName, 'EditView', $recordId) && $isEditableAsPerFlow == true) {
    ...
    public function IGisEditable($id) {
        ...
        if ($data['office'] == 'Production Division' || $data['office'] == 'Service Centre') {
