...
<div style="border:1px solid #ccc;padding:4%;">
    ...
    <div id="isReportScheduledArea" class="{if $IS_SCHEDULED neq '1'}hide{/if}" >
        ...
        <div class="row">
            <div class="form-group">
                ...
                <div class="col-lg-4">
                    ...
                    &nbsp;<input type="text" class="inputElement" data-rule-required="false" name="csv_separator" id="csv_separator"
                           placeholder=";" value="{$CSV_SEPARATOR}" {if $REPORT_FORMAT_CSV neq 'true'}disabled{/if} style="width:10%;" />
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="form-group">
                <label class="col-lg-2 control-label textAlignLeft">
                    {vtranslate('LBL_SCHEDULE_SKIP_EMPTY',$MODULE)}
                </label>
                <div class="col-lg-4">
                    <label class="checkbox" style="margin-left: 30px;display: inline;"><input name="schedule_skip_empty"
                                                                                              id="schedule_skip_empty" {if $schedule_skip_empty eq '1'} checked {/if}
                                                                                              type="checkbox"/></label>
                </div>
            </div>
        </div>
