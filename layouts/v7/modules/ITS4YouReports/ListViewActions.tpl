...
<div id="listview-actions" class="listview-actions-container">
    {assign var=LISTVIEW_MASSACTIONS_1 value=[]}
    {foreach item=LIST_MASSACTION from=$LISTVIEW_MASSACTIONS name=massActions}
        {if !empty($LIST_MASSACTION) && $LIST_MASSACTION->getLabel() eq 'LBL_EDIT'}
            {assign var=editAction value=$LIST_MASSACTION}
        {elseif !empty($LIST_MASSACTION) && $LIST_MASSACTION->getLabel() eq 'LBL_DELETE'}
