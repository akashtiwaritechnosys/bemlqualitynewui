...
{strip}
    ...
    <div class="reportsDetailHeader no-print">
        ...
        <form method="post" action="index.php" name="GeneratePDF" id="GeneratePDF" target="_blank">
            ...
            <input type="hidden" name="mode" value="ExportPDF"/>
            <input type="hidden" name="type" value=""/>
            <input type="hidden" name="record" value="{$RECORD_ID}"/>
            <input type="hidden" name="backgroundExport" value="" />
        ...
        <form method="post" action="index.php" name="PrintReport" id="PrintReport" target="_blank">
            <input type="hidden" name="module" value="ITS4YouReports"/>
            <input type="hidden" name="action" value="PrintReport"/>
            <input type="hidden" name="mode" value="GetPrintReport"/>
            <input type="hidden" name="type" value=""/>
            <input type="hidden" name="record" value="{$RECORD_ID}"/>
            <input type="hidden" name="form_report_name" id="form_report_name" value=""/>
        </form>
