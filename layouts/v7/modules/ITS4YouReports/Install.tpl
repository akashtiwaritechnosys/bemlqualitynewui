                    ...
                    <form name="install" id="editLicense" method="POST" action="index.php" class="form-horizontal">
                        ...
                        <div id="step2" class="padding1per" style="{if $STEP neq "2"}display:none;{/if}">
                            ...
                            <div class="controls">
                                ...
                                <br>
                                <div>
                                    {vtranslate('LBL_MORE_INFORMATION','Users')}&nbsp;
                                    <a href="https://it-solutions4you.com/tipstricks/vtiger-system-requirements/" target="_blank">
                                        {vtranslate('LBL_SYSTEM_REQUIREMENTS','ITS4YouInstaller')} https://it-solutions4you.com/tipstricks/vtiger-system-requirements/
                                    </a>
                                </div>
                                <br>
                                <div class="clearfix">
