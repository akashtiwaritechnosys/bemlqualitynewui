Inventory_Edit_Js("ServiceReports_Edit_Js", {
	...
	updateRowNumberForRow: function (lineItemRow, expectedSequenceNumber, currentSequenceNumber) {
		...
		} else if(type == 'INSTALLATION OF SUB ASSEMBLY FITMENT'){
			lineItemRow.find('[data-fieldname="' + 'sad_podate0' + '"]').attr('data-fieldname', 'sad_podate'+expectedSequenceNumber);
			lineItemRow.find('[data-fieldname="' + 'sad_date_oracs0' + '"]').attr('data-fieldname', 'sad_date_oracs'+expectedSequenceNumber);
		}
