    ...
    */
	...
	registerEventForImageDelete : function(){
        ...
        registerFileElementChangeEvent : function(container) {
            ...
            container.on('change', 'input[name="imagename[]"],input[name="sentdocument"],input[name="annos_file"],input[name="documents[]"]', function(e){
                ...
                var element = container.find('[name="imagename[]"],input[name="sentdocument"],input[name="annos_file"],input[name="documents[]"]');
	...
	/*registerEventForHideShowFlashText : function() {
		jQuery('#Announcements_editView_fieldName_annos_active').on('change', function(){
			 if($(this).is(":checked")) {
			 	jQuery('#Announcements_editView_fieldName_anno_flashtext').removeClass('hide');
				jQuery('#Announcements_editView_fieldName_anno_flashtext').closest('td').prev().removeClass('hide');
				jQuery('#Announcements_editView_fieldName_anno_flashtext').closest('td').removeClass('hide');
			 }else if($(this).is(":unchecked")){
			 	jQuery('#Announcements_editView_fieldName_anno_flashtext').addClass('hide');
				jQuery('#Announcements_editView_fieldName_anno_flashtext').closest('td').prev().addClass('hide');
				jQuery('#Announcements_editView_fieldName_anno_flashtext').closest('td').addClass('hide');
			 }
		});
		jQuery('#Announcements_editView_fieldName_annos_active').trigger('change');
	},*/
    ...
    registerEvents: function(callParent) {
		...
		//this.registerEventForHideShowFlashText();
    }
});
