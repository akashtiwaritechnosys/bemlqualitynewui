				...
				<table class="table table-bordered" id="lineItemTab">
					<tr>
						...
						{foreach key=LINEITEM_CUSTOM_FIELDKEY item=LINEITEM_CUSTOM_FIELD from=$LINEITEM_CUSTOM_FIELDS}
							...
							{if ($LINEITEM_CUSTOM_FIELD['fieldlabel'] eq 'Present Status' and $SUB_LINEITEM_CUSTOM_FIELDS|@count gt 0) or ($LINEITEM_CUSTOM_FIELD['fieldlabel'] eq 'Action Taken by DSM' and $SUB2_LINEITEM_CUSTOM_FIELDS|@count gt 0)}
