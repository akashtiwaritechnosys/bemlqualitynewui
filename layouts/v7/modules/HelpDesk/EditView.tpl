					...
					<div class='modal-overlay-footer clearfix'>
						<div class="row clearfix">
							<div class='textAlignCenter col-lg-12 col-md-12 col-sm-12 '>
								<button type='submit' onclick="{$MODULE}_Edit_Js.handleIsAlreadyTicketExistsForEquip(event)" class='btn btn-soft-success saveButton'>{vtranslate('LBL_SAVE', $MODULE)}</button>&nbsp;&nbsp;
