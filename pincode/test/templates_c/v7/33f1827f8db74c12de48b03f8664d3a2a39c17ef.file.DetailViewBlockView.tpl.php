<?php /* Smarty version Smarty-3.1.7, created on 2022-07-30 17:35:47
         compiled from "C:\xampp\htdocs\Pincode\includes\runtime/../../layouts/v7\modules\Vtiger\DetailViewBlockView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:12441481062e56bf3cedd51-36760730%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '33f1827f8db74c12de48b03f8664d3a2a39c17ef' => 
    array (
      0 => 'C:\\xampp\\htdocs\\Pincode\\includes\\runtime/../../layouts/v7\\modules\\Vtiger\\DetailViewBlockView.tpl',
      1 => 1658482725,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '12441481062e56bf3cedd51-36760730',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62e56bf3da13d',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62e56bf3da13d')) {function content_62e56bf3da13d($_smarty_tpl) {?>
...
"><ul id="imageContainer" class="imageSlider"><?php if (empty($_smarty_tpl->tpl_vars['IMAGE_DETAILS']->value)){?><div class="name"><span><strong><?php echo $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getModuleIcon();?>
</strong></span></div><?php }?><?php if ($_smarty_tpl->tpl_vars['MODULE_NAME']->value=='HelpDesk'||$_smarty_tpl->tpl_vars['MODULE_NAME']->value=='ServiceReports'){?><?php  $_smarty_tpl->tpl_vars['IMAGE_INFO'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['IMAGE_INFO']->_loop = false;
...
" width="400" height="300" /><span><a onclick="openInNewTab('<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['location'];?>
