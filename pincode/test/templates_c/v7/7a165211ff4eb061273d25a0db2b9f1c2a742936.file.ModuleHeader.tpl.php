<?php /* Smarty version Smarty-3.1.7, created on 2022-07-26 18:49:20
         compiled from "C:\xampp\htdocs\beml\includes\runtime/../../layouts/v7\modules\StockTransferOrders\ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:207015412962e037301d3a44-15907997%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '207015412962e037301d3a44-15907997',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62e0373026bca',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62e0373026bca')) {function content_62e0373026bca($_smarty_tpl) {?><div class="col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop"><div class="module-action-content clearfix <?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
" type="button" class="btn addButton btn-soft-info module-btn"<?php if (stripos($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),'javascript:')===0){?>onclick='<?php echo substr($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),strlen("javascript:"));?>
;'<?php }else{ ?>onclick="ServiceReports_List_Js.syncToSAPForSettingsMaster('<?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl();?>
')"<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
