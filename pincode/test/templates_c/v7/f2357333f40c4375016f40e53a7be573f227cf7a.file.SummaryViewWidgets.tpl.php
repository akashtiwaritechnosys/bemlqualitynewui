<?php /* Smarty version Smarty-3.1.7, created on 2022-06-23 13:41:26
         compiled from "C:\xampp\htdocs\beml\includes\runtime/../../layouts/v7\modules\Project\SummaryViewWidgets.tpl" */ ?>
<?php /*%%SmartyHeaderCode:24939298062b46d86c3b0f3-51693988%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f2357333f40c4375016f40e53a7be573f227cf7a' => 
    array (
      0 => 'C:\\xampp\\htdocs\\beml\\includes\\runtime/../../layouts/v7\\modules\\Project\\SummaryViewWidgets.tpl',
      1 => 1651513239,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '24939298062b46d86c3b0f3-51693988',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62b46d86d9ed5',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62b46d86d9ed5')) {function content_62b46d86d9ed5($_smarty_tpl) {?>
...
</h4><?php if ($_smarty_tpl->tpl_vars['DOCUMENT_WIDGET_MODEL']->value->get('action')){?><?php $_smarty_tpl->tpl_vars['PARENT_ID'] = new Smarty_variable($_smarty_tpl->tpl_vars['RECORD']->value->getId(), null, 0);?><div class="pull-right"><div class="dropdown"><button type="button" class="btn btn-soft-blue dropdown-toggle" data-toggle="dropdown"><span class="fa fa-plus" title="<?php echo vtranslate('LBL_NEW_DOCUMENT',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
</h4><?php if ($_smarty_tpl->tpl_vars['HELPDESK_WIDGET_MODEL']->value->get('action')){?><div class="pull-right"><button class="btn addButton btn-soft-blue btn-sm createRecord" type="button" data-url="<?php echo $_smarty_tpl->tpl_vars['HELPDESK_WIDGET_MODEL']->value->get('actionURL');?>
...
</h4><?php if ($_smarty_tpl->tpl_vars['MILESTONE_WIDGET_MODEL']->value->get('action')){?><div class="pull-right"><button class="btn addButton btn-sm btn-soft-blue createRecord"  id="createProjectMileStone" type="button" data-url="<?php echo $_smarty_tpl->tpl_vars['MILESTONE_WIDGET_MODEL']->value->get('actionURL');?>
"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
</h4><?php if ($_smarty_tpl->tpl_vars['TASKS_WIDGET_MODEL']->value->get('action')){?><div class="pull-right"><button class="btn addButton btn-sm btn-soft-blue createRecord" id="createProjectTask" type="button" data-url="<?php echo $_smarty_tpl->tpl_vars['TASKS_WIDGET_MODEL']->value->get('actionURL');?>
"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo vtranslate('LBL_ADD',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
