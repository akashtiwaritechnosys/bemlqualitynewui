<?php /* Smarty version Smarty-3.1.7, created on 2022-07-27 18:25:45
         compiled from "C:\xampp\htdocs\beml\includes\runtime/../../layouts/v7\modules\Products\ModuleHeader.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1252718141628a80e0295729-72201044%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1252718141628a80e0295729-72201044',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_628a80e06a3a1',
  'variables' => 
  array (
    'MODULE' => 0,
    'MODULE_MODEL' => 0,
...
<?php if ($_valid && !is_callable('content_628a80e06a3a1')) {function content_628a80e06a3a1($_smarty_tpl) {?><div class="col-sm-11 col-xs-10 padding0 module-action-bar clearfix coloredBorderTop"><div class="module-action-content clearfix <?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
...
" type="button" class="btn addButton btn-soft-info module-btn"<?php if (stripos($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),'javascript:')===0){?>onclick='<?php echo substr($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl(),strlen("javascript:"));?>
;'<?php }else{ ?>onclick="Vtiger_List_Js.syncToSAPMaterialMaster('<?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getUrl();?>
')"<?php }?>><div class="fa <?php echo $_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getIcon();?>
