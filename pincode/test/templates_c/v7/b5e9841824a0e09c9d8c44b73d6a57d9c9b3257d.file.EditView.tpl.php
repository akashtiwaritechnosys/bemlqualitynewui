<?php /* Smarty version Smarty-3.1.7, created on 2022-06-01 15:11:16
         compiled from "C:\xampp\htdocs\beml\includes\runtime/../../layouts/v7\modules\EmailTemplates\EditView.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1685833364629781949426a4-35887000%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b5e9841824a0e09c9d8c44b73d6a57d9c9b3257d' => 
    array (
      0 => 'C:\\xampp\\htdocs\\beml\\includes\\runtime/../../layouts/v7\\modules\\EmailTemplates\\EditView.tpl',
      1 => 1651513335,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1685833364629781949426a4-35887000',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_62978194acb0f',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_62978194acb0f')) {function content_62978194acb0f($_smarty_tpl) {?>
...
</div><div class="modal-overlay-footer clearfix" style="border-left-width: 0px;"><div class="row clearfix"><div class=' textAlignCenter col-lg-12 col-md-12 col-sm-12 '><button type='submit' class='btn btn-soft-success saveButton'><?php echo vtranslate('LBL_SAVE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button>&nbsp;&nbsp;<a class='cancelLink btn btn-soft-danger' href="javascript:history.back()" type="reset"><?php echo vtranslate('LBL_CANCEL',$_smarty_tpl->tpl_vars['MODULE']->value);?>
