...
class PDFMaker_PDFContent_Model extends PDFMaker_PDFContentUtils_Model {
    ...
    private static $inventory_table_array = Array("ServiceReports" => "vtiger_servicereports","PurchaseOrder" => "vtiger_purchaseorder","SalesOrder" => "vtiger_salesorder","Quotes" => "vtiger_quotes","Invoice" => "vtiger_invoice","Issuecards" => "vtiger_issuecards","Receiptcards" => "vtiger_receiptcards","Creditnote" => "vtiger_creditnote","StornoInvoice" => "vtiger_stornoinvoice");
    private static $inventory_id_array = Array("ServiceReports" => "servicereportsid","PurchaseOrder" => "purchaseorderid","SalesOrder" => "salesorderid","Quotes" => "quoteid","Invoice" => "invoiceid","Issuecards" => "issuecardid","Receiptcards" => "receiptcardid","Creditnote" => "creditnote_id","StornoInvoice" => "stornoinvoice_id");
    ...
    public function getSettingsForModule($module){
        ...
        $sql = "SELECT (margin_top * 10) AS margin_top,
              ...
              FROM vtiger_pdfmaker_settings INNER JOIN vtiger_pdfmaker ON  vtiger_pdfmaker.templateid = vtiger_pdfmaker_settings.templateid WHERE  vtiger_pdfmaker.module = ? AND vtiger_pdfmaker.module IN ('Invoice','Quotes','SalesOrder','PurchaseOrder','ServiceReports') ";
