...
<div class = "{$CLASS_VIEW_ACTION}">
    <div class="btn-group pull-right" style="display:flex">
        <button type="button" id="PreviousPageButton" class="btn btn btn-soft-secondary" {if !$PAGING_MODEL->isPrevPageExists()} disabled {/if}><i class="fa fa-caret-left"></i></button>
        {if $SHOWPAGEJUMP}
            <div  id="PageJump">
            ...
            <ul class="{$CLASS_VIEW_BASIC_ACTION} dropdown-menu" id="PageJumpDropDown">
                <li>
                    ...
                    <div class="listview-pagejump">
                        ...
                        <button type="button" id="pageToJumpSubmit" class="btn btn-soft-secondary {$CLASS_VIEW_PAGING_INPUT_SUBMIT} text-center">{'GO'}</button>
                    </div>    
                </li>
            </ul>
        {/if}
        <button type="button" id="NextPageButton" class="btn btn-soft-secondary" {if !$PAGING_MODEL->isNextPageExists()}disabled{/if}><i class="fa fa-caret-right"></i></button>
    </div>
