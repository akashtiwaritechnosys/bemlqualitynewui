	...
	{else}
		...
		<div class="fileUploadContainer text-left">
			<div class="fileUploadBtn btn btn-primary">
				...
				<input type="file" class="inputElement {if $MODULE eq 'Products' or $MODULE eq 'HelpDesk'}multi max-6{/if} {if $FIELD_MODEL->get('fieldvalue') and $FIELD_INFO["mandatory"] eq true} ignore-validation {/if}" name="{$FIELD_MODEL->getFieldName()}[]" value="{$FIELD_MODEL->get('fieldvalue')}"
