{strip}
	...
	<td>
		<select id="{$sr_action_one}" class="inputElement picklistfield" data-fieldtype="picklist" name="{$sr_action_one}" data-selected-value='{$data.$sr_action_one}'>
			<option value="">{vtranslate('LBL_SELECT_OPTION','Vtiger')}</option>
			<option {if trim(decode_html($data.$sr_action_one)) eq 'To be replaced'} selected {/if} value="To be replaced"> To be replaced </option>
			<option {if trim(decode_html($data.$sr_action_one)) eq 'Can be used'} selected {/if} value="Can be used"> Can be used </option>
		</select>
	</td>
	<td>
		<select id="{$sr_action_two}" class="inputElement picklistfield" data-fieldtype="picklist" name="{$sr_action_two}" data-selected-value='{$data.$sr_action_two}'>
			<option value="">{vtranslate('LBL_SELECT_OPTION','Vtiger')}</option>
			<option {if trim(decode_html($data.$sr_action_two)) eq 'Required'} selected {/if} value="Required">Required</option>
			<option {if trim(decode_html($data.$sr_action_two)) eq 'Repaired'} selected {/if} value="Replaced">Repaired</option>
			<option {if trim(decode_html($data.$sr_action_two)) eq 'Replaced'} selected {/if} value="Replaced">Replaced</option>
		</select>
	</td>
	<td>
		<select id="{$sr_replace_action}" class="inputElement picklistfield" data-fieldtype="picklist" name="{$sr_replace_action}" data-selected-value='{$data.$sr_replace_action}'>
			<option value="">{vtranslate('LBL_SELECT_OPTION','Vtiger')}</option>
			<option {if trim(decode_html($data.$sr_replace_action)) eq 'From BEML'} selected {/if} value="From BEML">From BEML</option>
			<option {if trim(decode_html($data.$sr_replace_action)) eq 'From Vendor'} selected {/if} value="From Vendor">From Vendor</option>
			<option {if trim(decode_html($data.$sr_replace_action)) eq 'From Customer'} selected {/if} value="From Customer">From Customer</option>
		</select>
	</td>
{/strip}