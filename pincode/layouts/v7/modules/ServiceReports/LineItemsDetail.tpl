        ...
        <table class="table table-bordered lineItemsTable" style = "margin-top:15px">
            ...
            <tbody>
                <tr>
                    ...
                    {/if}
                    {* Todo Handle Lable Generalisation *}
                    <td class="lineItemFieldName">
                ...
                {foreach key=INDEX item=LINE_ITEM_DETAIL from=$RELATED_PRODUCTS}
                    <tr>
                        ...
                        {/if}
                        {* Todo Handle Generalisation *}
                        <td>
                            {$LINE_ITEM_DETAIL["sr_action_one$INDEX"]}
                        </td>
                        <td>
                            {$LINE_ITEM_DETAIL["sr_action_two$INDEX"]}
                        </td>
                        <td>
                            {$LINE_ITEM_DETAIL["sr_replace_action$INDEX"]}
                        </td>
                    </tr>
                {/foreach}
            </tbody>
