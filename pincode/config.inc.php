...
$HELPDESK_SUPPORT_EMAIL_ID = 'support@bemlindia.demo';
...
/* database configuration
      ...
      db_username
      db_password
      db_name  Database connection failed: Host '6464.46.54' is not allowed to connect to this MySQL server in
*/
...
$site_URL = 'http://10.80.2.84/pincode/';

$PORTAL_URL = $site_URL.'customerportal';
$root_directory = '/var/www/html/pincode/';
$cache_dir = 'cache/';
