...
// if (vtigercron_detect_run_in_cli() || (isset($_SESSION["authenticated_user_id"]) &&	isset($_SESSION["app_unique_key"]) && $_SESSION["app_unique_key"] == $application_unique_key)) {
	...
	include_once('modules/FunctionalLocations/SyncRecentlyUpdatedFunctionalLocations.php');
	SyncRecentlyUpdatedFunctionalLocations([]);
	include_once('modules/ServiceEngineer/ReCalculateEngineerAssignementCron.php');
	ReCalculateEngineerAssignementCron([]);
